...
MainToolBar::MainToolBar(wxWindow* parent, wxAuiManager* manager)
{
	...
	brushes_toolbar->AddTool(PALETTE_TERRAIN_REFRESH_TOOL, wxEmptyString, refresh_bitmap, wxNullBitmap, wxITEM_CHECK, "Refresh Tile (restored from origmap)", wxEmptyString, NULL);
	brushes_toolbar->AddSeparator();
